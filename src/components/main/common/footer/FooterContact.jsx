...
export default function FooterContact() {
  return (
    <>
      <div className="footer-contact flex flex-wrap justify-between lg:justify-center gap-5 md:gap-10 lg:gap-20 py-2 px-5 mt-5">
        <div className="footer-col w-full sm:w-[calc(50%-20px)] md:max-w-[380px] pr-0 md:pr-10 border-1 md:border-r border-[#DCE2EA]">
          ...
          <div className="address-text text-[#34495E] text-[14px] md:text-[16px] mt-4">
      ...
      <div className="flex flex-wrap items-center justify-center gap-[21px] my-[30px] px-5">
        <Link href="#">
          <AppStore />
        </Link>
        <Link href="#">
