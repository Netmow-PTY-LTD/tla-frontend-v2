...
export const dummyPages = [
  ...
  },
  {
    ...
    name: 'Careers',
    slug: 'careers',
    description: 'Join our team and view job openings.',
  },
  {
    _id: '7',
    name: 'FAQ',
  ...
  },
  {
    ...
    description: 'The rules and regulations of our website.',
  },
  {
    _id: '10',
    name: 'Support',
...
export const dummySubscriptions = [
  {
    ...
    features: ['Basic support', '1 user', 'Community access'],
    description: 'A basic free plan for personal use.',
    trialPeriod: 0,
    maxUsers: 1,
    isActive: true,
    isRecommended: false,
  ...
  },
  {
    ...
    currency: 'USD',
    billingCycle: 'monthly',
    features: ['Email support', 'Up to 3 users', 'Basic analytics'],
    description: 'Affordable entry-level plan for small teams.',
    trialPeriod: 7,
    maxUsers: 3,
    isActive: true,
    isRecommended: true,
    planCode: 'STARTER_009',
  ...
  },
  {
    ...
    currency: 'USD',
    billingCycle: 'monthly',
    features: ['Priority support', '10 users', 'Advanced analytics'],
  ...
  },
  {
    ...
    currency: 'USD',
    billingCycle: 'monthly',
    features: ['Dedicated support', 'Unlimited users', 'Custom integrations'],
    description: 'Advanced features for businesses and enterprises.',
    trialPeriod: 30,
    maxUsers: null,
    isActive: true,
    isRecommended: false,
    planCode: 'BUSINESS_079',
  ...
  },
  {
    ...
    currency: 'USD',
    billingCycle: 'monthly',
    features: ['24/7 support', 'Account manager', 'Enterprise compliance'],
    description: 'Custom solutions for large-scale organizations.',
    trialPeriod: 0,
    maxUsers: null,
    isActive: false,
    isRecommended: false,
    planCode: 'ENTERPRISE_199',
  ...
  },
  {
    ...
    currency: 'USD',
    billingCycle: 'yearly',
    features: ['Same as Pro Plan', '2 months free'],
    description: 'Yearly version of the Pro Plan with discount.',
    trialPeriod: 14,
    maxUsers: 10,
    isActive: true,
    isRecommended: true,
    planCode: 'PRO_ANNUAL_290',
  ...
  },
  {
    ...
    currency: 'USD',
    billingCycle: 'monthly',
    features: ['All Pro features', 'Student ID required'],
    description: 'Affordable plan for verified students.',
    trialPeriod: 30,
    maxUsers: 1,
    isActive: true,
    isRecommended: false,
    planCode: 'STUDENT_005',
  ...
  },
  {
    ...
    currency: 'USD',
    billingCycle: 'monthly',
    features: ['Discounted rate', 'All Pro features', 'Support for nonprofits'],
    description: 'Special pricing for nonprofit organizations.',
    trialPeriod: 30,
    maxUsers: 15,
    isActive: true,
    isRecommended: false,
    planCode: 'NONPROFIT_015',
  ...
  },
  {
    ...
    currency: 'USD',
    billingCycle: 'monthly',
    features: ['10 team members', 'Team dashboards', 'Slack integration'],
    description: 'Designed for small to medium-sized teams.',
    trialPeriod: 14,
    maxUsers: 10,
    isActive: true,
    isRecommended: true,
  ...
  },
  {
    ...
    slug: 'beta-tester-plan',
    price: 0,
    currency: 'USD',
    billingCycle: 'monthly',
    features: ['Access to beta features', 'Feedback channel'],
    description: 'For selected users testing new features.',
    trialPeriod: 0,
    maxUsers: 1,
    isActive: false,
    isRecommended: false,
