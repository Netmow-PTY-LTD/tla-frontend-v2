...
import { useSendContactMessageMutation, useGetContactInfoQuery } from '@/store/features/public/contactApiService';
...
export default function ContactPageComponent() {
  ...
  const { data: contactInfoData } = useGetContactInfoQuery();
                    ...
                    <div className="w-full lg:w-5/12">
                      <div className="home-cta-text md:pr-5 lg:pr-20">
                        ...
                        <div className="contact-info">
                          ...
                          {contactInfo?.website && (
                            <Link href={contactInfo.website.startsWith('http') ? contactInfo.website : `https://${contactInfo.website}`} target="_blank">
                              <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="25"
                                height="25"
