...
import { useAddMetaInfoMutation } from '@/store/features/admin/SEOMetaApiService';
...
const pagesSchema = z.object({
  ...
  metaImage: z.instanceof(File, { message: 'Meta image is required' }),
});

export default function AddNewMetaInfoModal({
  open,
  setOpen,
  refetchMetaInfo,
}) {
  ...
  const handleMetaInfoAdd = async (values) => {
    ...
    try {
      ...
      showErrorToast(error?.data?.message || 'Failed to add meta info');
    }
  };
