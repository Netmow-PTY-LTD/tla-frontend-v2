...
export default function OthersCasesManagement() {
  ...
  const {
    ...
    refetch,
    isFetching,
  } = useGetAllLeadsForAdminQuery({ page, LIMIT, search: debouncedSearch ,filters:JSON.stringify( { serviceName: 'Others' } )  });
  ...
  return (
    <>
      <h2 className="font-bold text-2xl"> Others Cases List</h2>
      <LeadDataTable
        data={leadList?.data || []}
        columns={columns}
