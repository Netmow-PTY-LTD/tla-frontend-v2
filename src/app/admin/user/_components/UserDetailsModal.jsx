    ...
    >
       <div className="space-y-4 text-sm">
        ...
        <section className="border-b pb-2">
          ...
          <p><strong>Phone Verified:</strong> {data.isPhoneVerified}</p>
          <p><strong>Account Status:</strong> {data.accountStatus}</p>
          <p><strong>Verified Account:</strong> {data.isVerifiedAccount ? 'Yes' : 'No'}</p>
        ...
        <section className="border-b pb-2">
          ...
          <p><strong>Lawyer Email:</strong> {profile.lawyerContactEmail}</p>
          <p><strong>Law Society #:</strong> {profile.law_society_member_number || 'N/A'}</p>
          <p><strong>Practising Certificate #:</strong> {profile.practising_certificate_number || 'N/A'}</p>
        </section>

        {/* Metadata */}
        <section>
          <h3 className="font-semibold text-gray-800 mb-2">Joining Data</h3>
          <p><strong>Open Account:</strong> {dayjs(data.createdAt).format('DD MMM YYYY, hh:mm A')}</p>
