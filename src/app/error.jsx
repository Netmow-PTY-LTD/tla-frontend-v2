...
export default function Error({ error, reset }) {
  ...
  return (
    <div className="min-h-[70vh] flex flex-col justify-center items-center px-4 bg-gray-50/30">
      <div className="max-w-md w-full bg-white shadow-lg rounded-2xl p-8 text-center border border-gray-100">
        ...
        <p className="text-gray-500 mb-8 text-sm leading-relaxed">
          We encountered an error communicating with our servers. Please check your internet connection and try again, or return later.
        </p>
