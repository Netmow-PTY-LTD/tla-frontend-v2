...
END:VCARD`;
    ...
    <html>
      <head>
        ...
        <style>
          ...
          .section { padding:50px 0 40px 0; background-image:url('${
            window.location.origin
          }/assets/img/Bg-hero1.webp'); background-size:cover; background-position:center; background-repeat:no-repeat; }
          .container { width:90%; margin:0 auto; }
          .flex { display:flex; flex-wrap:wrap; gap:20px; position:relative; top:30px; align-items:flex-start; }
          .profile-img { width:423px; height:531px; object-fit:cover; border-radius:8px; }
          .info { padding-left:50px; color:white; flex:1; min-width:300px; }
          .info h2 { font-size:48px; margin:0; }
          .info .designation { font-size:18px; margin-top:16px; }
          .divider { width:142px; height:0.5px; background:white; margin-top:16px; opacity:0.5; }
          .contact { display:flex; align-items:center; gap:16px; font-size:16px; font-weight:600; margin-top:16px; }
          .contact-icon { width:40px; height:40px; display:flex; justify-content:center; align-items:center; border:1px solid white; border-radius:50%; flex-shrink:0; }
          .badge-container img { vertical-align:middle; }
        </style>
      </head>
      <body>
  ...
  #profile-print-section, 
  #profile-print-section * {
    visibility: visible; /* show only this section */
  }
