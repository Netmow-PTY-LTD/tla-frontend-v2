...
export default function Login() {
  return (
    ...
    >
      <div className="tla-auth-box max-w-[1100px] w-full mx-auto">
        <div className="flex flex-wrap w-full">
          {/* Form Section */}
          <div
            className="w-full md:w-1/2 p-[20px] md:p-[38px] relative"
            style={{
          ...
          <div
            ...
            style={{
              backgroundImage: `url('/assets/img/right-image.png')`,
              backgroundRepeat: 'no-repeat',
              backgroundSize: 'cover',
              backgroundPosition: 'center center',
          ...
          >
            <div className="tla-auth-image">
              {/* <Image
                src="/assets/img/right-image.png"
                width={215}
                height={373}
                alt="Auth Image"
              /> */}
