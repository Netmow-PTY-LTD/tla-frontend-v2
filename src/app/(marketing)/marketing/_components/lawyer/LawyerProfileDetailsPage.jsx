...
export default function LawyerProfileDetailsPage({ userId }) {
        ...
        <div className="max-w-5xl mx-auto p-6 space-y-6">
            ...
            {user.regUserType === 'lawyer' && (
                <Card>
                    ...
                    {
                        user.profile?.experience ? <CardContent>
                            ...
                            <p>There is no content upload yet.</p>
                        </CardContent>
                    }
                ...
                user.regUserType === 'lawyer' && <Card>
                    ...
                    <CardContent className="space-y-3">
                        {user.profile?.photos?.photos?.length > 0 ? (
                            ...
                            <p>No photos content upload yet</p>
                        </div>
                        ...
                        {user.profile?.photos?.videos?.length > 0 ? (
                            ...
                            <p>No videos content upload yet</p>
                        </div>
                        }
                    </CardContent>
                </Card>
            ...
            {user.regUserType === 'lawyer' && (
                <Card>
                    ...
                    <CardContent>
                        {user.profile?.accreditation?.length > 0 ? user.profile.accreditation.map((acc) => (
            ...
            {/* Profile Q&A */}
            {user.profile?.profileQA?.length > 0 && user.regUserType === 'lawyer' && (
                <Card>
                    <CardHeader>
                    ...
                    <CardContent className="space-y-4">
                        {user.profile.profileQA.map((qa, idx) => (
                            <div key={idx}>
                                ...
                                <p className="text-muted-foreground">{qa.answer?qa.answer:'no answer'}</p>
