...
export default async function LeadDetailsPage({ params }) {
  ...
  return (
    <div>
      <div className="bg-white rounded px-5 pt-2">
        ...
        <div className="mt-5">
          ...
          <div className="p-3 bg-[#F3F3F3] mt-3 rounded-lg">
            ...
            <p className="text-sm text-[#34495E] ">
              ...
              your rights and options. Let us help you navigate this challenging
        ...
        <div className="mt-5 space-y-3 mb-5">
          ...
          <div>
            <p className="text-[#34495E]">What kind of Law service you need?</p>
