...
const SubscriptionInvoiceDocument = ({ transaction }) => {
    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={[styles.section, { marginTop: 30 }]}>
          ...
          {/* Subscription */}
          {subscriptionType === 'subscription' && subscriptionId?.subscriptionPackageId && (
            <View style={styles.tableRow}>
              <Text style={{ flex: 2 }}>{subscriptionId.subscriptionPackageId.name}</Text>
              <Text style={{ flex: 1 }}>
              ...
              <Text style={{ flex: 1, textAlign: 'right' }}>
                {formatCurrency(subscriptionId.subscriptionPackageId.price?.amount || subTotal, currency)}
              </Text>
            </View>
          )}
