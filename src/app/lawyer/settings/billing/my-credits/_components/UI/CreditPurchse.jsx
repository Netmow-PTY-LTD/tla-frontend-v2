...
const CreditsPurchase = () => {
  ...
  return (
    <div>
      ...
      <div className="border-0 bg-white rounded-lg shadow-sm mb-4 relative">
        <div className="bg-[#00C3C0] absolute text-white p-[10px] rounded-tl-md rounded-br-md text-sm font-medium">
